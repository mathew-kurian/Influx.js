...
class Store extends EventEmitter {
  ...
  constructor(...dispatchers) {
    ...
    const listeners = (this.getDispatcherListeners || this.constructor.getDispatcherListeners).call(this) || [];
    ...
    for (let dispatcher of dispatchers) {
      ...
      this.dispatcherToken = dispatcher.register(payload => {
        if (this.onAction) this.onAction(payload.event, ...payload.args);
